...
- [Документация APEX](./docs/README.md) - главная документация
- [Архитектура](./docs/architecture/README.md) - архитектура системы
- [Безопасность](./docs/SECURITY.md) - безопасность системы

### **🚀 Быстрый старт**
- [Быстрый старт](./docs/quickstart/README.md) - быстрое начало работы
- [Настройка](./docs/setup/README.md) - настройка компонентов
- [Развертывание](./docs/deployment/README.md) - развертывание системы

### **🔄 CI/CD и DevOps**
- [CI/CD документация](./docs/cicd/README.md) - автоматизация
- [Простая версия CI/CD](./docs/cicd/simple/README-CI-CD-SIMPLE.md) - Docker Compose
- [Kubernetes версия CI/CD](./docs/cicd/kubernetes/README-CI-CD.md) - Kubernetes

### **🔗 Интеграции и API**
- [Интеграции](./docs/integrations/README.md) - внешние интеграции
- [API endpoints](./docs/project/endpoints.md) - описание API
- [CRM поля](./docs/project/crm-fields.md) - маппинг полей amoCRM

### **🧪 Тестирование и проект**
- [Тестирование](./docs/testing/README.md) - план тестирования
- [Проект](./docs/project/README.md) - структура проекта
- [Воронка продаж](./docs/project/pipelines.md) - воронка продаж
